...
class Employee_model extends CI_Model
{
    ...
    public function get_employees($zone_ids ,$start, $length, $search = '', $order_column = 'name', $order_dir = 'asc')
    {


        if (empty($zone_ids)) {
            return $this->db->query("SELECT * FROM employee WHERE 1=0");
        }
    ...
    public function getTotal_employees( $zone_ids , $search = '')
    {
