...
?>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table id="example2" class="table table-bordered  table-striped "
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><?php echo isset($users['user']['id']) ? $users['user']['id'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Pjp_Code']) ? $users['user']['Pjp_Code'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Employee_Id']) ? $users['user']['Employee_Id'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Name']) ? $users['user']['Name'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Email_Id']) ? $users['user']['Email_Id'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Mobile_No']) ? $users['user']['Mobile_No'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Level']) ? $users['user']['Level'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Designation']) ? $users['user']['Designation'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Designation_label']) ? $users['user']['Designation_label'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['DOJ']) ? $users['user']['DOJ'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Employee_Status']) ? $users['user']['Employee_Status'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Town']) ? $users['user']['Town'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['District_Code']) ? $users['user']['District_Code'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['District']) ? $users['user']['District'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['State']) ? $users['user']['State'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Address']) ? $users['user']['Address'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($users['user']['Region']) ? $users['user']['Region'] : 'N/A'; ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table id="example" class="table table-bordered  table-striped "
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo isset($mapping['id']) ? $mapping['id'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['DB_Code']) ? $mapping['DB_Code'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Distinct_Column']) ? $mapping['Distinct_Column'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_1']) ? $mapping['Level_1'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_2']) ? $mapping['Level_2'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_3']) ? $mapping['Level_3'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_4']) ? $mapping['Level_4'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_5']) ? $mapping['Level_5'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_6']) ? $mapping['Level_6'] : 'N/A'; ?>
                                                            </td>
                                                            <td><?php echo isset($mapping['Level_7']) ? $mapping['Level_7'] : 'N/A'; ?>
                                                            </td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
    ...
    function generateMenu(hierarchy) {
        ...
        hierarchy.forEach(item => {
            ...
            <li data-level="${item.level}" onclick="setActive(this)">
                <a href="javascript:void(0);" class="has-children" data-name="${item.name}" data-dbcode="${item.dbCode}">
                    <span class="nav-icon">
    ...
    function initializeMenu() {
        ...
        menuItems.forEach(item => {
            item.addEventListener('click', (event) => {
                ...
                console.log(name, dbCode);
                dataload(name, dbCode); // or dataload(name) if that's what you need
    ...
    <script>
    function dataload(name, dbCode) {
        $.ajax({
            url: `<?php echo base_url('welcome/Usermaster_data'); ?>`,
            method: 'GET',
            data: {
                level: name,
                db_code: dbCode // Send both parameters
            },
            dataType: 'json',
            success: function(data) {
                // Handle the data received from the server
                console.log('Data loaded for level:', name, 'with DB Code:', dbCode, data);
        ...
        data.usermaster.forEach(user => {
            ...
            <ul class="members">
                <li class="member">
                    ...
                    <div class="col-md-3">
                        <h4 class="member-name">${user.Name ? user.Name : 'N/A'}</h4>
                        <div class="member-skills">${user.Designation_label ? user.Designation_label : 'N/A'}</div>
                    </div>
                    <div class="col-md-3">
                        <p>${user.Email_Id ? user.Email_Id : 'N/A'}</p>
                        <p>Mobile: ${user.Mobile_No ? user.Mobile_No : 'N/A'}</p>
                    </div>
                    <div class="col-md-5">
                        <p>ID: ${user.id ? user.id : 'N/A'} <br>
                           Region: ${user.State ? user.State : 'N/A'}, Market: UP (East)</p>
                    </div>
                </li>
            </ul>
        `;
