                            ...
                            <form action="<?php echo base_url('update-password'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <input id="current_password" type="password" class="form-control"
                                        autocomplete="new-password" name="current_password" placeholder=" Password"
                                        required="required">
                                </div>

                                <div class="form-group">
                                    <input id="new_password" type="password" autocomplete="new-password"
                                        class="form-control" name="new_password" placeholder="confirm  Password"
                                        required="required">
                                </div>

                                <div class="form-group">
                                    <div class="fxt-switcher-description2 text-right">
                                        <!-- You can add additional descriptions or links here if needed -->
                                    </div>
                                </div>
