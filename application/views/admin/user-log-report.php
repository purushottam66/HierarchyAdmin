            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box shadow-2dp b-r-2">
                        <div class="box-body">
                            <a href="<?php echo base_url('admin/userlogreport'); ?>" class="btn active text-white " style="background:#FB8B03"> user log report</a>
                            <a href="<?php echo base_url('admin/mapping_log_report'); ?>" class="btn active "> mapping log report</a>
                            <!-- Filter Section -->
                            <!-- <div class="row mb-3">
                                <div class="col-md-3">
...
<script>
    $(document).ready(function() {
        var table = $('#user_logs_table').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '<?php echo base_url("admin/user-log-report-get-logs-ajax"); ?>',
                type: 'GET',
                data: function(d) {
