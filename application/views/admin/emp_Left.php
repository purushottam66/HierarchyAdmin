                        ...
                        <div class="box-body">
                            ...
                            <form id="saveReplaceForm" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="vacant-container">
                                        <div class="form-group p-b-10">
                            ...
                            <div class="card mt-3">
                                <div class="table-responsive p-3">
                                    <h5 class="text-center">
                                        Distributor List of emp : <span id="selectedEmployeeName"></span>
                ...
                success: function(response) {
                    ...
                    if (parsedResponse.status == 'success') {
                        ...
                        window.location.href =
                            '<?php echo site_url("admin/UserMovement"); ?>?message=' +
                            encodeURIComponent(parsedResponse.message) + '&status=success';
    ...
    $(document).ready(function() {
        ...
        function updatePagination_Replace(response) {
            ...
            if (totalPages > 1) {
                ...
                if (currentPage > 1) {
                    paginationHtml +=
                        '<li class="page-item"><a class="page-link prev-page__" href="#" data-page="1">First</a></li>';
                    paginationHtml +=
                        '<li class="page-item"><a class="page-link prev-page__" href="#" data-page="' + (
                ...
                for (var i = startPage; i <= endPage; i++) {
                    if (i === currentPage) {
                        paginationHtml += '<li class="page-item active"><a class="page-link" href="#">' + i +
                            '</a></li>';
                    } else {
                        paginationHtml +=
                            '<li class="page-item"><a class="page-link page-number__" href="#" data-page="' + i +
                            '">' + i + '</a></li>';
                    }
                }
                ...
                if (currentPage < totalPages) {
                    paginationHtml +=
                        '<li class="page-item"><a class="page-link next-page__" href="#" data-page="' + (
                            currentPage + 1) + '">Next</a></li>';
                    paginationHtml +=
                        '<li class="page-item"><a class="page-link next-page__" href="#" data-page="' + totalPages +
                        '">Last</a></li>';
                }
            ...
            $('.page-number__, .prev-page__, .next-page__').off('click').on('click', function(e) {
                e.preventDefault();
        ...
        function addRadioEventListeners() {
            ...
            $('.employee-radio').on('change', function() {
                            ...
                            if (response) {
                                ...
                                if (empresponse.employees && empresponse.employees.length > 0) {
                                    $.each(empresponse.employees, function(index, employee) {
                                        if (employee.vacant_status == 1 || employee
                                            .pjp_code === selectedEmployeepjp_code) {
                                            let option = '<option value="' + escapeHtml(
                                                    employee.pjp_code) + '" data-id="' +
                                                escapeHtml(employee.level) + '">' +
                                                escapeHtml(employee.name) +
                                                ' (Level: ' + escapeHtml(employee
                                                    .level) + ')</option>';
                                ...
                                if (response && response.data && response.data.length > 0) {
                                    ...
                                    $.each(response.data, function(index, item) {
                                        const jsonData = JSON.stringify({
                                            DB_Code: item.Customer_Code ||
                                                'N/A',
                                            Sales_Code: item.Sales_Code ||
                                                'N/A',
                                            Distribution_Channel_Code: item
                                                .Distribution_Channel_Code ||
                                                'N/A',
                                            Division_Code: item.Division_Code ||
                                                'N/A',
                                            Customer_Type_Code: item
                                                .Customer_Type_Code || 'N/A',
                                            Customer_Group_Code: item
                ...
                function updatePagination_emp(response) {
                    ...
                    paginationHtml += '<div class="pagination-info">';
                    paginationHtml += 'Showing ' + start + ' to ' + end + ' of ' + totalRecords +
                        ' entries';
                    paginationHtml += '</div>';
                    ...
                    if (totalPages > 1) {
                        ...
                        if (currentPage > 1) {
                            paginationHtml +=
                                '<li class="page-item"><a class="page-link prev-page_emp" href="#" data-page="1">First</a></li>';
                            paginationHtml +=
                                '<li class="page-item"><a class="page-link prev-page_emp" href="#" data-page="' +
                                (currentPage - 1) + '">Previous</a></li>';
                        }
                        ...
                        for (var i = startPage; i <= endPage; i++) {
                            if (i === currentPage) {
                                ...
                                paginationHtml +=
                                    '<li class="page-item"><a class="page-link page-number_emp" href="#" data-page="' +
                                    i + '">' + i + '</a></li>';
                            }
                        }
                        ...
                        if (currentPage < totalPages) {
                            paginationHtml +=
                                '<li class="page-item"><a class="page-link next-page_emp" href="#" data-page="' +
                                (currentPage + 1) + '">Next</a></li>';
                            paginationHtml +=
                                '<li class="page-item"><a class="page-link next-page_emp" href="#" data-page="' +
                    ...
                    $('.page-number_emp, .prev-page_emp, .next-page_emp').on('click', function(e) {
                        e.preventDefault();
                        var pageNumber = $(this).data('page');
    ...
    $(document).ready(function() {
        ...
        function updatePagination(response) {
            ...
            if (totalPages > 1) {
                ...
                if (currentPage > 1) {
                    paginationHtml +=
                        '<li class="page-item"><a class="page-link prev-page" href="#" data-page="1">First</a></li>';
                    paginationHtml += '<li class="page-item"><a class="page-link prev-page" href="#" data-page="' +
                        (currentPage - 1) + '">Previous</a></li>';
                }
                ...
                for (var i = startPage; i <= endPage; i++) {
                    if (i === currentPage) {
                        ...
                        paginationHtml +=
                            '<li class="page-item"><a class="page-link page-number" href="#" data-page="' + i +
                            '">' + i + '</a></li>';
                    }
                }

                if (currentPage < totalPages) {
                    paginationHtml += '<li class="page-item"><a class="page-link next-page" href="#" data-page="' +
                        (currentPage + 1) + '">Next</a></li>';
                    paginationHtml += '<li class="page-item"><a class="page-link next-page" href="#" data-page="' +
                        totalPages + '">Last</a></li>';
                }
