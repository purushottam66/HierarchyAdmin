    ...
    $(document).ready(function() {
        ...
        function updatePagination_Replace(response) {
            ...
            if (totalPages > 1) {
                ...
                if (currentPage > 1) {
                    paginationHtml += '<li class="page-item"><a class="page-link prev-page__" href="#" data-page="1">First</a></li>';
                    paginationHtml += '<li class="page-item"><a class="page-link prev-page__" href="#" data-page="' + (currentPage - 1) + '">Previous</a></li>';
                }
                ...
                for (var i = startPage; i <= endPage; i++) {
                    if (i === currentPage) {
                        ...
                        paginationHtml += '<li class="page-item"><a class="page-link page-number__" href="#" data-page="' + i + '">' + i + '</a></li>';
                    }
                }

                if (currentPage < totalPages) {
                    paginationHtml += '<li class="page-item"><a class="page-link next-page__" href="#" data-page="' + (currentPage + 1) + '">Next</a></li>';
                    paginationHtml += '<li class="page-item"><a class="page-link next-page__" href="#" data-page="' + totalPages + '">Last</a></li>';
                }
            ...
            $('.employee-radio').on('change', function() {
                ...
                function updatePagination_emp(response) {
                    ...
                    if (totalPages > 1) {
                        ...
                        if (currentPage > 1) {
                            paginationHtml += '<li class="page-item"><a class="page-link prev-page_emp" href="#" data-page="1">First</a></li>';
                            paginationHtml += '<li class="page-item"><a class="page-link prev-page_emp" href="#" data-page="' + (currentPage - 1) + '">Previous</a></li>';
                        }
                        ...
                        for (var i = startPage; i <= endPage; i++) {
                            if (i === currentPage) {
                                ...
                                paginationHtml += '<li class="page-item"><a class="page-link page-number_emp" href="#" data-page="' + i + '">' + i + '</a></li>';
                            }
                        }

                        if (currentPage < totalPages) {
                            paginationHtml += '<li class="page-item"><a class="page-link next-page_emp" href="#" data-page="' + (currentPage + 1) + '">Next</a></li>';
                            paginationHtml += '<li class="page-item"><a class="page-link next-page_emp" href="#" data-page="' + totalPages + '">Last</a></li>';
                        }
