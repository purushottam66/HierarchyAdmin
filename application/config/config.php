...
|
*/
$config['base_url'] = 'http://localhost/HierarchyAdmin/';
...
|
*/
$config['log_threshold'] = 4;  // This enables error logging
$config['log_path'] = '';
...
$config['sess_save_path'] = sys_get_temp_dir(); // Use system temp directory for session files
