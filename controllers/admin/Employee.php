...
class Employee extends CI_Controller
{
    ...
    public function Unmapped_Employee_ajex_load()
    {
        ...
        $total_get_employee = $this->Employee_model->getTotal_employees_unmaped($zone_ids,    $search);
        $employee_s = $this->Employee_model->get_employees_unmaped($zone_ids ,$start, $length, $search, $order_column, $order_dir);
    ...
    public function Employee_ajex_load()
    {
        ...
        $order_column = $this->input->post('order[0][column]', TRUE); 
        ...
        $total_get_employee = $this->Employee_model->getTotal_employees($zone_ids ,$search);
        $employee_s = $this->Employee_model->get_employees( $zone_ids ,$start, $length, $search, $order_column_name, $order_dir);
